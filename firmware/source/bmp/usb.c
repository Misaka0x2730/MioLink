...
static const uint8_t desc_ms_os_20[] =
{
    ...
    U16_TO_U8S_LE(0x0008), U16_TO_U8S_LE(MS_OS_20_SUBSET_HEADER_CONFIGURATION), 0x00, 0x00, U16_TO_U8S_LE(MS_OS_20_DESC_LEN - 10),

    // Function Subset header: length, type, first interface, reserved, subset length
    U16_TO_U8S_LE(0x0008), U16_TO_U8S_LE(MS_OS_20_SUBSET_HEADER_FUNCTION), 4, 0, U16_TO_U8S_LE(0x009C),
    ...
    '2', 0,     '-', 0,     'b', 0,     'e', 0,     '5', 0,     'f', 0,
    '-', 0,     'd', 0,     '9', 0,     '3', 0,     '6', 0,     '9', 0,
