...
_bmp_target_option(BMP_TARGET_LATTICE "Lattice ECP5" CONFIG_LATTICE)

option(BMP_TARGET_LATTICE_ECP5_DECODE "Lattice ECP5 register decoding (only if Lattice is enabled)" ON)
list(APPEND _BMP_TARGET_OPTION_NAMES BMP_TARGET_LATTICE_ECP5_DECODE)
if(BMP_TARGET_LATTICE AND BMP_TARGET_LATTICE_ECP5_DECODE)
    list(APPEND BMP_TARGET_DEFS CONFIG_LATTICE_ECP5_DECODE=1)
endif()
