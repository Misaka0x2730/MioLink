...
#ifndef MIOLINK_BOARDS_PINOUT_MIOLINK_REV_A_H
#define MIOLINK_BOARDS_PINOUT_MIOLINK_REV_A_H
...
#define MIOLINK_REVA_LED_SER_PIN (12) /**< Serial-activity LED GPIO. */

#define MIOLINK_REVA_TARGET_TCK_PIN     (24) /**< JTAG/SWD clock pin. */
#define MIOLINK_REVA_TARGET_TDO_PIN     (17) /**< JTAG TDO / SWO input pin. */
#define MIOLINK_REVA_TARGET_TDI_PIN     (28) /**< JTAG TDI pin. */
#define MIOLINK_REVA_TARGET_TMS_PIN     (26) /**< JTAG TMS / SWD SWDIO pin. */
#define MIOLINK_REVA_TARGET_TMS_DIR_PIN (27) /**< Direction control for level-shifted TMS/SWDIO. */

#define MIOLINK_REVA_TARGET_UART_TX_PIN (8)  /**< Target UART TX pin. */
