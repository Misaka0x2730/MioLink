...
#ifndef MIOLINK_BOARDS_MIOLINK_H
#define MIOLINK_BOARDS_MIOLINK_H
...
#define BOARD_MIOLINK /**< Selects the MioLink (rev A/B) board build. */
...
#define PICO_RP2040_B0_SUPPORTED (0) /**< Disables RP2040 B0 silicon workarounds; all MioLink boards have B1+. */
#endif

#endif /* MIOLINK_BOARDS_MIOLINK_H */
