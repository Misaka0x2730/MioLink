...
#define TRACESWO_RX_DMA_MIN_TIMEOUT UART_BRIDGE_DEFAULT_RX_DMA_MIN_TIMEOUT_MS /**< Lower bound on DMA RX timeout, in ms. */
#define TRACESWO_RX_DMA_MAX_TIMEOUT UART_BRIDGE_DEFAULT_RX_DMA_MAX_TIMEOUT_MS /**< Upper bound on DMA RX timeout, in ms. */
